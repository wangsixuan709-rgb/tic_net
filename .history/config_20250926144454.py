...
data_config = {
    ...
    'data_dir': '/media/yangao/SANet/NoduleNet-master/data/LUNA16/allset/combined/',
    # put lung mask downloaded from LUNA16 to this path
    'lung_mask_dir': '/media/yangao/SANet/NoduleNet-master/data/LUNA16/seg-lungs-LUNA16/seg-lungs-LUNA16',
    # directory for putting all preprocessed results for training to this path
    'preprocessed_data_dir': '/media/yangao/SANet/NoduleNet-master/data/LUNA16/intermideate/',
