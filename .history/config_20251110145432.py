...
data_config = {
    ...
    'data_dir': '/home/yangao/LUNG/SANet/NoduleNet-master/data/LUNA16/allset/combined/',
    # put lung mask downloaded from LUNA16 to this path
    'lung_mask_dir': '/home/yangao/LUNG/SANet/NoduleNet-master/data/LUNA16/seg-lungs-LUNA16/seg-lungs-LUNA16',
    # directory for putting all preprocessed results for training to this path
    'preprocessed_data_dir': '/home/yangao/LUNG/SANet/NoduleNet-master/data/LUNA16/intermideate/',
    # original annotations csv file path
    'annos_dir': '/media/yangao/SANet/TiCNet/annotations/annotations.csv',
    'annos_excluded_dir': '/media/yangao/SANet/TiCNet/annotations/annotations_excluded.csv',
    "seriesuids_dir": '/media/yangao/SANet/TiCNet/annotations/seriesuids.csv',
    'annos_save_dir':'/media/yangao/SANet/TiCNet/annotations1',
    'new_annos_dir': '/media/yangao/SANet/TiCNet/annotations/new_annotations.csv',
    'new_annos_excluded_dir': '/media/yangao/SANet/TiCNet/annotations/new_annotations_excluded.csv',
...
train_config = {
    ...
    'num_workers': 8,
    #
    'train_set_list': ['split/0_train.csv'],
    'val_set_list': ['split/0_val.csv'],
    'test_set_name': 'split/0_val.csv',
    'label_types': ['bbox'],
...
train_config['initial_checkpoint'] = os.path.join(train_config['out_dir'], 'model/100_best.pth')
